...
echo "  - Exact paper hyperparameters: batch_size=32, Adam lr=1e-3"
echo "  - Sigmoid activation and Average pooling (as per research)"
...
echo "  - Overfitting prevention (8% critical stop - STRICT medical-grade)"
